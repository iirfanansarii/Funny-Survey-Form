...
<meta charset="ISO-8859-1">
    ...
    <body>
        <h1 id="title">Fresh Lover  Sign Up Form </h1>
        <p id="description" >Hey Buddy ! Thanks For Sign Up To Share Your Experience  Which May Help Others In Anyway.</p>
     
     <!-- below line for action tag url -->
          <s:url var="registerUser" value="/user/register-user"/>
       ...
       <!-- model attribute is use bind user class data to this form  -->
         ...
         <!--  ${registerUser}  to send total data to controller   -->
          ...
          <f:form id="survey-form" modelAttribute="userCommand" action="${registerUser}" method="post">
